const Footer = () => {
  ...
  <div className="container pt-9">
    <div className="mb-9 flex justify-center">
      <a href="https://github.com/ayubsh" className="mr-9 text-neutral-800 dark:text-neutral-200">
        <svg
      ...
      <a href="https://github.com/ayubsh" className="text-neutral-800 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4"
          fill="currentColor"
