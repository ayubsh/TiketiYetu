const Footer = () => {
  ...
  <div class="container pt-9">
    <div class="mb-9 flex justify-center">
      <a href="https://github.com/ayubsh" class="mr-9 text-neutral-800 dark:text-neutral-200">
        <svg
      ...
      <a href="https://github.com/ayubsh" class="text-neutral-800 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
